...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            os.execute(string.format("%s set %s toggle", volumewidget.cmd, volumewidget.channel))
            volumewidget.update()
        end),
...
run_once("mopidy")
run_once("redshift")
awful.util.spawn_with_shell("xset r rate 200 35")
